    ...
    <div style={{ marginBottom: "1rem" }}>
      ...
      >
        ...
        <p style={{ margin: "0", fontSize: "13px", color: "#4a6741" }}>
          <strong>What are variants?</strong> Different versions of your product
          (e.g., sizes, colors, types)
        </p>
      </div>
      ...
      {variants.length === 0 ? (
        ...
        >
          ...
          <p style={{ color: "#888", fontSize: "14px", marginBottom: "20px" }}>
            Add variants if your product comes in different sizes, colors, or
            types
          </p>
          <button
            type="button"
