...
const VariantsManagerComponent = (props) => {
  ...
  return (
    <div style={{ marginBottom: "1rem" }}>
      ...
      >
        <h4 style={{ margin: "0 0 10px 0", color: "#2d5a2d" }}>🏷️ Product Variants Manager</h4>
        <p style={{ margin: "0", fontSize: "13px", color: "#4a6741" }}>
          <strong>What are variants?</strong> Different versions of your product (e.g., sizes, colors, types)
        </p>
      </div>
      ...
      {variants.length === 0 ? (
        ...
        >
          ...
          <h4 style={{ color: "#666", marginBottom: "10px" }}>No Variants Added</h4>
          <p style={{ color: "#888", fontSize: "14px", marginBottom: "20px" }}>
            Add variants if your product comes in different sizes, colors, or types
          </p>
          <button
            type="button"
        ...
        <>
          {variants.map((variant, index) => (
            ...
            >
              ...
              >
                <h5 style={{ margin: 0, color: "#333" }}>🏷️ Variant #{index + 1}</h5>
                <button
                  type="button"
