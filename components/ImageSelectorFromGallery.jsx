    ...
    <div style={{ marginBottom: "1rem" }}>
      ...
      >
        ...
        <ul style={{ margin: "5px 0", paddingLeft: "20px" }}>
          <li>Click "Select from Image Gallery" to browse uploaded images</li>
          <li>Click on images to select/deselect them</li>
          <li>Selected images will appear at the top with green borders</li>
          <li>Use the × button to remove selected images</li>
          <li>
            Upload new images using the{" "}
            <a href="/admin-upload.html" target="_blank" rel="noreferrer">
              Upload Tool
            </a>
          </li>
        </ul>
