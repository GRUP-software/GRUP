...
export const connectDatabase = async () => {
    try {
        ...
        logger.error(
            'Please check your MONGODB_URI environment variable for any connection issues.'
        );
