        ...
        const trendingProducts = await Product.aggregate([
            ...
            },
            {
                $addFields: {
                    groupActivity: {
                        $ifNull: [
                            { $arrayElemAt: ['$recentGroups.count', 0] },
                            0,
                        ],
                    },
                },
        ...
        const alerts = await Product.aggregate([
                ...
                $lookup: {
                    ...
                    pipeline: [
                        ...
                        },
                        {
                            $group: {
                                _id: null,
                                weeklyDemand: { $sum: '$items.quantity' },
                            },
                        },
                    ],
                    as: 'demand',
            ...
            },
            {
                $addFields: {
                    ...
                    weeklyDemand: {
                        $ifNull: [
                            { $arrayElemAt: ['$demand.weeklyDemand', 0] },
                            0,
                        ],
                    },
                    daysUntilStockout: {
                        ...
                        $cond: [
                            {
                                $lte: [
                                    '$stock',
                                    { $multiply: ['$lowStockThreshold', 0.5] },
                                ],
                            },
                            'CRITICAL',
                            {
