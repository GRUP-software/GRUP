    ...
    return [
        ...
        async (req, res, next) => {
            try {
                ...
                console.log(
                    `✅ Successfully uploaded ${uploadResults.length} image(s) to Cloudinary`
                );
    ...
    return [
        ...
        async (req, res, next) => {
            try {
                ...
                console.log(
                    `📤 Uploading single image to Cloudinary: ${req.file.originalname}`
                );
                ...
                console.error(
                    '❌ Single image Cloudinary upload error:',
                    error
                );
                res.status(500).json({
                    success: false,
