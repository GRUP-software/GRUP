...
router.get("/admin/api/resources/Order/records/:id", verifyToken, async (req, res) => {
  try {
...
router.post("/admin/api/resources/Order/records/:id/edit", verifyToken, async (req, res) => {
  try {
    const { id } = req.params
